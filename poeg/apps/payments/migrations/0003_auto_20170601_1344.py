...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(blank=True, max_length=20, unique=True, verbose_name='variable symbol'),
        ),
        migrations.AlterField(
            model_name='paymenttransaction',
            name='price',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), max_digits=8, verbose_name='price'),
        ),
    ]
